...
<body class="bg-gray-50 font-sans antialiased" x-data="{ sidebarOpen: false }">
    ...
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <div x-show="sidebarOpen" @click="sidebarOpen = false" x-transition:enter="transition-opacity ease-linear duration-300"
            ...
            x-transition:leave-end="opacity-0" class="fixed inset-0 bg-gray-900/80 z-40 md:hidden"></div>
        ...
        <aside
            ...
            <div>
                <div class="h-20 flex items-center px-6 border-b border-white/10 bg-primary-950/50">
                    <a href="/" class="flex items-center space-x-3">
                        <img src="{{ asset('assets/images/LogoKebunRaya.jpeg') }}" alt="Logo"
                            class="h-10 w-10 rounded-full border-2 border-primary-400" onerror="this.style.display='none'">
                        <div>
                ...
                <nav class="p-4 space-y-2 mt-4">
                    ...
                    <a href="#" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group bg-primary-800 text-white shadow-lg shadow-primary-900/50 border border-primary-700">
                    ...
                    <a href="#" class="flex items-center px-4 py-3 rounded-xl text-primary-100 hover:bg-white/10 hover:text-white transition-all duration-200 group">
                        <svg class="w-5 h-5 mr-3 text-primary-400 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="p-4 border-t border-white/10 bg-primary-950/30">
                <div class="flex items-center gap-3">
                    <img class="h-10 w-10 rounded-full border-2 border-primary-500" src="https://ui-avatars.com/api/?name=Admin+Kebun&background=0D9488&color=fff" alt="">
        ...
        <main class="flex-1 overflow-y-auto h-screen relative">
            ...
            <div class="md:hidden bg-white/90 backdrop-blur-md border-b border-gray-200 p-4 sticky top-0 z-30 flex items-center justify-between">
                ...
                <button @click="sidebarOpen = true" class="text-gray-600 focus:outline-none bg-gray-100 p-2 rounded-lg">
