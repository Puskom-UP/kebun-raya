        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-24">
            <div class="animate-fade-in-up">
                ...
                <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight drop-shadow-lg">
                    Kebun Raya<br>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-200 to-white">Universitas
                        Pahlawan</span>
                </h1>

                <p
                    class="text-lg md:text-xl text-primary-100/90 max-w-3xl mx-auto mb-10 leading-relaxed drop-shadow-md">
                    Pusat konservasi tumbuhan yang mengusung tema pelestarian flora dataran rendah Sumatera.
                    Menjaga warisan alam untuk masa depan yang berkelanjutan.
                </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div
                    ...
                    <div
                        class="w-16 h-16 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-yellow-500/30">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Terbaik 1</h3>
                    <h4 class="text-primary-600 font-semibold mb-4">Pengelola Anggaran Terbaik</h4>
                    <p class="text-gray-600 leading-relaxed text-sm">
                        Penghargaan atas transparansi dan efisiensi dalam pengelolaan dana konservasi dan pengembangan
                        fasilitas.
                    </p>
                </div>
                ...
                <div
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Terbaik 3</h3>
                    <h4 class="text-primary-600 font-semibold mb-4">Kebun Raya Daerah</h4>
                    <p class="text-gray-600 leading-relaxed text-sm">
                        Diakui sebagai salah satu Kebun Raya Daerah dengan progres pembangunan dan koleksi flora paling
                        signifikan.
                    </p>
                </div>
                ...
                <div
                    ...
                    <div
                        class="w-16 h-16 bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-blue-500/30">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M7 4V2m10 2V2M3 8h18M5 4h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2z">
                            </path>
                        </svg>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Terbaik 3</h3>
                    <h4 class="text-primary-600 font-semibold mb-4">Pengelolaan Media Sosial</h4>
                    <p class="text-gray-600 leading-relaxed text-sm">
                        Apresiasi atas keaktifan menyebarkan edukasi lingkungan melalui platform digital yang
                        interaktif.
                    </p>
                </div>
            </div>
